...
(use-package ibuffer
  ...
  (keymap-set ibuffer-mode-map "M-j" #'suderman/window-down)
  (keymap-set ibuffer-mode-map "M-k" #'suderman/window-up)
  (keymap-set ibuffer-mode-map "M-l" #'suderman/window-right)
