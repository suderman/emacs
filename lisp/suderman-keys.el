...
(keymap-set suderman/leader-window-map "+" #'suderman/enlarge-window-width)
(keymap-set suderman/leader-window-map "-" #'suderman/shrink-window-width)
(keymap-set suderman/leader-window-map "d" #'delete-window)
(keymap-set suderman/leader-window-map "h" #'suderman/window-left)
(keymap-set suderman/leader-window-map "j" #'windmove-down)
(keymap-set suderman/leader-window-map "k" #'windmove-up)
(keymap-set suderman/leader-window-map "l" #'windmove-right)
(keymap-set suderman/leader-window-map "o" #'delete-other-windows)
(keymap-set suderman/leader-window-map "q" #'delete-window)
(keymap-set suderman/leader-window-map "s" #'suderman/split-window-below-and-focus)
(keymap-set suderman/leader-window-map "u" #'suderman/split-window-below-and-focus)
(keymap-set suderman/leader-window-map "v" #'suderman/split-window-right-and-focus)
(keymap-set suderman/leader-window-map "i" #'suderman/split-window-right-and-focus)
(keymap-set suderman/leader-window-map "H" #'suderman/shrink-window-width)
(keymap-set suderman/leader-window-map "J" #'suderman/enlarge-window-height)
(keymap-set suderman/leader-window-map "K" #'suderman/shrink-window-height)
(keymap-set suderman/leader-window-map "L" #'suderman/enlarge-window-width)
...
(global-set-key (kbd "M-h") #'suderman/window-left)
(global-set-key (kbd "M-j") #'suderman/window-down)
(global-set-key (kbd "M-k") #'suderman/window-up)
(global-set-key (kbd "M-l") #'suderman/window-right)
...
(dolist (binding '(("<f5>" . suderman/reload-config)
                   ...
                   ("M-j" . suderman/window-down)
                   ("M-k" . suderman/window-up)
                   ("M-l" . suderman/window-right)
